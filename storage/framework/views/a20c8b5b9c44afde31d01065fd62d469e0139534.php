...
<?php foreach($attributes->onlyProps(['darkMode','form','tag','wire:click','href','target','type','color','keyBindings','tooltip','disabled','icon','size','dusk','class','outlined','iconPosition','iconPosition']) as $__key => $__value) {
    $$__key = $$__key ?? $__value;
} ?>
<?php $attributes = $attributes->exceptProps(['darkMode','form','tag','wire:click','href','target','type','color','keyBindings','tooltip','disabled','icon','size','dusk','class','outlined','iconPosition','iconPosition']); ?>
<?php foreach (array_filter((['darkMode','form','tag','wire:click','href','target','type','color','keyBindings','tooltip','disabled','icon','size','dusk','class','outlined','iconPosition','iconPosition']), 'is_string', ARRAY_FILTER_USE_KEY) as $__key => $__value) {
    $$__key = $$__key ?? $__value;
} ?>
...
<?php $component = $__env->getContainer()->make(Illuminate\View\AnonymousComponent::class, ['view' => 'filament::components.button','data' => ['darkMode' => $darkMode,'form' => $form,'tag' => $tag,'wire:click' => $wireClick,'href' => $href,'target' => $target,'type' => $type,'color' => $color,'keyBindings' => $keyBindings,'tooltip' => $tooltip,'disabled' => $disabled,'icon' => $icon,'size' => $size,'dusk' => $dusk,'class' => $class,'outlined' => $outlined,'iconPosition' => $iconPosition]] + (isset($attributes) ? (array) $attributes->getIterator() : [])); ?>
...
<?php endif; ?><?php /**PATH C:\Users\user\PhpstormProjects\minijust\storage\framework\views/6a3191bbe583dc4fe1b8574b2354f38b5c631f80.blade.php ENDPATH**/ ?>