...
} elseif ($_instance->childHasBeenRendered('PhVVysM')) {
    $componentId = $_instance->getRenderedChildComponentId('PhVVysM');
    $componentTag = $_instance->getRenderedChildComponentTagName('PhVVysM');
    $html = \Livewire\Livewire::dummyMount($componentId, $componentTag);
    $_instance->preserveRenderedChild('PhVVysM');
} else {
    $response = \Livewire\Livewire::mount('filament.core.global-search');
    $html = $response->html();
    $_instance->logRenderedChild('PhVVysM', $response->id(), \Livewire\Livewire::getRootElementTagName($html));
}
echo $html;
?>
...
<?php unset($__componentOriginalc254754b9d5db91d5165876f9d051922ca0066f4); ?>
<?php endif; ?>
<?php /**PATH C:\Users\user\PhpstormProjects\minijust\vendor\filament\filament\src\/../resources/views/components/layouts/app.blade.php ENDPATH**/ ?>