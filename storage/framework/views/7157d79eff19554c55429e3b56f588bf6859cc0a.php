...
<nav class="navbar navbar-expand-lg fixed-top navbar-white navbar-custom sticky" id="navbar">
    <div class="container">
        ...
        <div class="collapse navbar-collapse" id="navbarCollapse">
            ...
            <a class="btn btn-secondary nav-btn" href="<?php echo e(route('register')); ?>">
                Inscription
            </a>
        ...
        <div class="modal-content">
            ...
            <div class="modal-body p-5">
                ...
                <div class="d-grid gap-3">
                    <a class="btn btn-dark btn-lg" href="<?php echo e(route('register')); ?>">
            ...
            <div class="modal-body p-5">
                ...
                <div class="contact">
                    <div data-aos="" data-aos-duration="1800">
                        <form method="post" action="<?php echo e(route('login')); ?>" class="contact-form" name="myForm" id="myForm">
                            <?php echo csrf_field(); ?>
                            <div>
...
$message = $__bag->first($__errorArgs[0]); ?> <small class="text-red-400"> <?php echo e($message); ?></small> <?php unset($message);
...
<?php /**PATH C:\Users\user\PhpstormProjects\minijust\resources\views/front/index.blade.php ENDPATH**/ ?>