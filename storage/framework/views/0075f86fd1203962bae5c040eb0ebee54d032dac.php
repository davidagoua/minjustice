<div class="main-sidebar">
    ...
    <div class="sidebar-inner">
        ...
        <ul class="icon-menu">
            <!-- Activity -->
            <li >
                <a href="<?php echo e(route('dashboard')); ?>" title="Tableau de bord" id="home-sidebar-menu" >
                    <i class="sidebar-svg" data-feather="home"></i>
                </a>
            </li> <!-- Layouts -->

            <li>
                <a href="<?php echo e(route('documents')); ?>" id="elements-sidebar-menu" title="Mes documents">
                    <i class="sidebar-svg" data-feather="file-text"></i>
                </a>
            </li> <!-- Bugs -->
            <li>
                <a href="<?php echo e(route('demande.type')); ?>" id="layouts-sidebar-menu" title="Demande de document">
                    <i class="sidebar-svg" data-feather="file-plus"></i>
                </a>
            </li> <!-- Bounties -->
            <li>
                <a href="<?php echo e(route('notification')); ?>" id="components-sidebar-menu" title="Filiation">
                ...
                <div id="profile-menu" class="dropdown profile-dropdown dropdown-trigger is-spaced is-up">
                    ...
                    <div class="dropdown-menu" role="menu">
                        <div class="dropdown-content">
                            ...
                            <a href="<?php echo e(route('profile.index')); ?>" class="dropdown-item is-media">
                                <div class="icon">
...
<?php /**PATH C:\Users\user\PhpstormProjects\minijust\resources\views/parts/sidebar.blade.php ENDPATH**/ ?>