...
<?php $component->withAttributes(['icon' => \Illuminate\View\Compilers\BladeCompiler::sanitizeComponentAttribute($hintIcon)]); ?>
                        <?php echo filled($hint) ? \Illuminate\Support\Str::of($hint)->markdown()->sanitizeHtml() : null; ?>
...
<?php endif; ?>
<?php $component->withAttributes([]); ?>
                <?php echo \Illuminate\Support\Str::of($helperText)->markdown()->sanitizeHtml(); ?>
...
<?php /**PATH C:\Users\user\PhpstormProjects\minijust\vendor\filament\forms\src\/../resources/views/components/field-wrapper/index.blade.php ENDPATH**/ ?>