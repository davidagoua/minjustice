...
<?php endif; ?>
        ...
        <ul class="px-6 space-y-6">
            <?php $__currentLoopData = \Filament\Facades\Filament::getNavigation(); $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $group => ['items' => $items, 'collapsible' => $collapsible]): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                <?php if (isset($component)) { $__componentOriginalc254754b9d5db91d5165876f9d051922ca0066f4 = $component; } ?>
<?php $component = $__env->getContainer()->make(Illuminate\View\AnonymousComponent::class, ['view' => 'filament::components.layouts.app.sidebar.group','data' => ['label' => $group,'collapsible' => $collapsible]] + (isset($attributes) ? (array) $attributes->getIterator() : [])); ?>
...
<?php $attributes = $attributes->except(collect($constructor->getParameters())->map->getName()->all()); ?>
<?php endif; ?>
<?php $component->withAttributes(['label' => \Illuminate\View\Compilers\BladeCompiler::sanitizeComponentAttribute($group),'collapsible' => \Illuminate\View\Compilers\BladeCompiler::sanitizeComponentAttribute($collapsible)]); ?>
                    <?php $__currentLoopData = $items; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $item): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                        <?php if (isset($component)) { $__componentOriginalc254754b9d5db91d5165876f9d051922ca0066f4 = $component; } ?>
<?php $component = $__env->getContainer()->make(Illuminate\View\AnonymousComponent::class, ['view' => 'filament::components.layouts.app.sidebar.item','data' => ['active' => $item->isActive(),'icon' => $item->getIcon(),'url' => $item->getUrl(),'badge' => $item->getBadge(),'shouldOpenUrlInNewTab' => $item->shouldOpenUrlInNewTab()]] + (isset($attributes) ? (array) $attributes->getIterator() : [])); ?>
...
<?php /**PATH C:\Users\user\PhpstormProjects\minijust\vendor\filament\filament\src\/../resources/views/components/layouts/app/sidebar/index.blade.php ENDPATH**/ ?>